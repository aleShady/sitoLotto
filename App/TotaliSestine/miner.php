    ...
    while($count <= 1){
           ...
           if($isotopi == false){
            ...
            $Vv02uoebc004 = array('1-3','1-4','2-4','2-5','3-5');}
               $tipo= $Vfs2niaige2t->ordine;
        $Vjrtbrrwdfmt = 24;
        $Vwvjd4q4sfbo = new Quadrature($Vzkdzprmnhzz, $Vv02uoebc004, $Vfs2niaige2t->tripla, $isotopi);
...
if(checkDuplicato($arr2) == true && $quad['diagonale'] != 45) return false;
        ...
        if($numAmbi == 0 && $numTerni == 0 && $numQuaterne == 0){
        $EsitiNegativi = 1;
        $EsitiPositivi = 0;
        }
        else {$EsitiNegativi = 0;
        $EsitiPositivi = 1;
        }
        $numEsiti = 1;
